...
public class ChuThap extends HinhThoi {
    {
        maHinh = 6;
    }
    public ChuThap() {
   ...
   public ChuThap(double netVe, Color mauNetVe, Color mauNen) {
    ...
    public void veHinh(double x, double y, double w, double h) {
       mau_Net_Ve();
          ((Polygon) (hinh)).getPoints().setAll(x + 0.25*w, y + h, x + 0.25*w, y + 0.75*h, x, y + 0.75*h, 
                x, y + 0.25*h, x + 0.25*w, y + 0.25*h, x + 0.25*w, y, x + 0.75*w, y, x + 0.75*w, y + 0.25*h,
                x + w, y + 0.25*h, x + w, y + 0.75*h, x + 0.75*w, y + 0.75*h, x + 0.75*w, y + h);
    }

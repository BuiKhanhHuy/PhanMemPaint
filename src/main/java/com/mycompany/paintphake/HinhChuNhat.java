...
public class HinhChuNhat extends HinhVe {
    ...
    // bien tam cuc bo
    {
        ...
        this.hinh = new Rectangle();
        this.hinh.setId("hinhChuNhat");
        ...
        ((Rectangle) hinh).addEventHandler(MouseEvent.MOUSE_PRESSED, new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent e) {
                if (isDoiMauNen == true) {
                    System.out.println("Hinh Chu Nhat");
                    ((Rectangle) hinh).setFill(mauNen);
                    isTaoMoi = true;
                }
                if (isDoiMauNetVe == true) {
                    ((Rectangle) hinh).setStroke(mauNetVe);
                }
            }
        });
    }
    ...
    public HinhChuNhat(double netVe, Color mauNetVe, Color mauNen) {
        this.netVe = netVe;
